...
public class Local3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonMap.setOnClickListener(v -> {
            Uri gmmIntentUri = Uri.parse("google.navigation:q=Pesqueiro+Paraíso+da+Pesca");
        ...
        buttonSite.setOnClickListener(v -> {
            Uri uri = Uri.parse("http://www.pesqueiroparaiso.com.br");
